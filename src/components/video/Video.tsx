...
export const Video: React.FC<IGenVideo & { inline?: boolean }> = ({
  vimeoVideoId,
  inline,
  ...props
}) => {
  ...
  return (
    <SVideo inline={inline}>
      ...
      >
        <iframe
          // src={`https://player.vimeo.com/video/${vimeoVideoId}?autoplay=1&loop=1&title=0&byline=0&muted=1&sidedock=0&controls=0&portrait=0`}
